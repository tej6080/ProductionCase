 ...
 * under the License.
 * 
 * 把二维图改成卫卫星图：源码中的 var c = t.__bmap = new BMap.Map(m) 这个就是新建的一个地图，这个使用的是百度地图默认的地图类型 BMAP_NORMAL_MAP
 * 可以对这个位置就行修改，修改为 var c = t.__bmap = new BMap.Map(m, {mapType:BMAP_HYBRID_MAP})
 * 
 */
...
! function (t, e) {
    ...
    l.prototype.dimensions = ["lng", "lat"], l.prototype.setZoom = function (t) {
    ...
    }, l.dimensions = l.prototype.dimensions, l.create = function (t, m) {
        var c, d = m.getDom();
        t.eachComponent("bmap", function (t) {
            ...
            if (!t.__bmap) {
                ...
                var i = t.__bmap = new BMap.Map(n, {mapType:BMAP_HYBRID_MAP}),
                    a = new f(o);
            ...
            if (r && p) {
                ...
                i.centerAndZoom(s, p)
            }(c = new l(i, m)).setMapOffset(t.__mapOffset || [0, 0]), c.setZoom(p), c.setCenter(r), t.coordinateSystem = c
        ...
        render: function (i, t, a) {
            ...
            var c = i.__mapStyle,
                d = i.get("mapStyle") || {},
                l = JSON.stringify(d);
            JSON.stringify(c) !== l && (Object.keys(d).length && o.setMapStyle(d), i.__mapStyle = JSON.parse(l));
            var f = i.__mapStyle2,
                h = i.get("mapStyleV2") || {},
                u = JSON.stringify(h);
            JSON.stringify(f) !== u && (Object.keys(h).length && o.setMapStyleV2(h), i.__mapStyle2 = JSON.parse(u)), r = !1
        }
